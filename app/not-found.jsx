...
export default function NotFound() {
  return (
    <div style={{
      ...
      gap: 24, padding: '106px 20px 40px', textAlign: 'center',
    }}>
      <h1 style={{
        fontFamily: "'Saira Condensed', sans-serif", fontSize: 'clamp(60px, 12vw, 150px)',
      ...
      <p style={{ fontFamily: "'Archivo', sans-serif", fontSize: 18, color: 'rgba(255,255,255,0.7)', margin: 0 }}>
